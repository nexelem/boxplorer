...
public class ListAdapter extends BaseExpandableListAdapter implements OnChildClickListener {
	...
	public void onGroupCollapsed(int groupPosition) {
		...
		for(Item item : boxes.get(groupPosition).items){
	...
	public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        Item item = boxes.get(groupPosition).get(childPosition);
        boolean expanded = false;
        
        if(item.state != ItemState.DEFAULT_EXPANDED){
        	item.state = ItemState.DEFAULT_EXPANDED;
        ...
        for(Box box : boxes){
        	for(Item i : box.items){
        		if(i.state == ItemState.DEFAULT_EXPANDED && (!expanded || i != item)){
        			i.state = ItemState.DEFAULT_TO_HIDE;
        		}
        	}
        }
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        	...
        	AlphaAnimation alpha = new AlphaAnimation(1.0f, 0.0f);
   	        ...
   	        alpha.setAnimationListener(new AnimationListener() {
				...
				public void onAnimationEnd(Animation arg0) {
					boxes.get(groupPosition).remove(childPosition);
        ...
        } else if(item.state == ItemState.DEFAULT_TO_HIDE){
        	item.state = ItemState.DEFAULT;
        ...
        holder.name.setText(boxes.get(groupPosition).get(childPosition).name);
        holder.add.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				boxes.get(groupPosition).get(childPosition).state = ItemState.REMOVE;
				ListAdapter.this.notifyDataSetChanged();	
			}
		});
        holder.edit.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(context, "TODO: edit item", Toast.LENGTH_SHORT).show();
			}
		});
        holder.move.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(context, "TODO: move item", Toast.LENGTH_SHORT).show();
     ...
     * Creating group view
     */
    public View getGroupView(final int groupPosition, boolean isExpanded, View view, final ViewGroup parent) {
        ...
        holder.add.setOnClickListener(new OnClickListener() {	
			...
			public void onClick(View view) {
				...
				boxes.get(groupPosition).add(new Item("Test "+(boxes.get(groupPosition).size()+1)));
				ListAdapter.this.notifyDataSetChanged();
			}
		});
   
        holder.name.setText(boxes.get(groupPosition).name);
        return view;
    }
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return boxes.get(groupPosition).get(childPosition);
    }
    ...
    public int getChildrenCount(int groupPosition) {
        return boxes.get(groupPosition).size();
    }
